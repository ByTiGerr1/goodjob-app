...
class TrabajoPorRevisarScreen extends StatefulWidget {
  ...
  @override
  State<TrabajoPorRevisarScreen> createState() => _TrabajoPorRevisarScreenState();
}

class _TrabajoPorRevisarScreenState extends State<TrabajoPorRevisarScreen> {
